...
const authentication = {
	...
	allowSelfRegistration:
		(process.env.ALLOW_SELF_REGISTRATION ?? "true") === "true",
	...
	callback: {
		facebook:
			process.env.FACEBOOK_CALLBACK_URL || `${client.url}/auth/oauth/facebook`,
		google:
			process.env.GOOGLE_CALLBACK_URL || `${client.url}/auth/oauth/google`,
	},
	oauth: {
		google: {
		...
		azure: {
			...
			redirect_uri:
				...
				`${metaverse.metaverseServerUrl}/oauth/azure/callback`,
