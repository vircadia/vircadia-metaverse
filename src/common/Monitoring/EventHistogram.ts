...
export class EventHistogram extends Histogram {
    ...
    constructor(pNumberOfBuckets: number, pMillisecondsPerBucket: number) {
        ...
        this._totalHistogramMilliseconds =
            this._numBuckets * this._bucketMilliseconds;
    ...
    GetHistogram(): any {
        ...
        return {
            ...
            timeBase:
                this._timeBase -
                this._bucketMilliseconds *
                    (this._numBuckets - this._lastBucket),
            baseNumber:
                Math.floor(this._timeBase / this._bucketMilliseconds) +
                this._lastBucket +
                1,
            type: 'accumulation',
            values: values,
