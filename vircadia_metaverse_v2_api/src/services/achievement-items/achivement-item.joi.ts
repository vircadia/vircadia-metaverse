...
export const createAchievementItemsSchema = Joi.object().keys({
    icon,
    name,
    description,
});

export const editAchievementItemsSchema = Joi.object({
...
export const findAchievementItemsSchema = Joi.object({
    per_page,
    page,
});
