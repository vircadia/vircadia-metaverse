...
export default {
    before: {
        ...
        find: [validators.form(findQuestSchema, joiReadOptions)],
        get: [validators.form(getQuestSchema, joiReadOptions)],
        create: [
            iff(isAdminUser()).else(disallow('external')),
            validators.form(createQuestSchema, joiOptions),
        ],
        update: [disallow()],
        patch: [
            iff(isAdminUser()).else(disallow('external')),
            validators.form(patchQuestSchema, joiOptions),
        ],
        remove: [disallow()],
    },
